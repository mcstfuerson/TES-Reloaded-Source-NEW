			...
			if (svls) {
				...
				for (TList<TESWeather>::Iterator Itr = DataHandler->weathers.Begin(); !Itr.End() && Itr.Get(); ++Itr) {
					...
					if (!strcmp(Section, Weather->EditorName)) {
						Settings["BaseSunriseR"] = s.baseSunriseR = 0.0f;
						Settings["BaseSunriseG"] = s.baseSunriseG = 0.0f;
						Settings["BaseSunriseB"] = s.baseSunriseB = 0.0f;
						Settings["BaseMiddayR"] = s.baseMiddayR = 0.0f;
						Settings["BaseMiddayG"] = s.baseMiddayG = 0.0f;
						Settings["BaseMiddayB"] = s.baseMiddayB = 0.0f;
						Settings["BaseSunsetR"] = s.baseSunsetR = 0.0f;
						Settings["BaseSunsetG"] = s.baseSunsetG = 0.0f;
						Settings["BaseSunsetB"] = s.baseSunsetB = 0.0f;
						Settings["BaseNightR"] = s.baseNightR = 0.0f;
						Settings["BaseNightG"] = s.baseNightG = 0.0f;
						Settings["BaseNightB"] = s.baseNightB = 0.0f;
						Settings["BaseDistance"] = s.baseDistance = 5000.0f;
						Settings["AccumSunriseR"] = s.accumSunriseR = 0.0f;
						Settings["AccumSunriseG"] = s.accumSunriseG = 0.0f;
						Settings["AccumSunriseB"] = s.accumSunriseB = 0.0f;
						Settings["AccumMiddayR"] = s.accumMiddayR = 0.0f;
						Settings["AccumMiddayG"] = s.accumMiddayG = 0.0f;
						Settings["AccumMiddayB"] = s.accumMiddayB = 0.0f;
						Settings["AccumSunsetR"] = s.accumSunsetR = 0.0f;
						Settings["AccumSunsetG"] = s.accumSunsetG = 0.0f;
						Settings["AccumSunsetB"] = s.accumSunsetB = 0.0f;
						Settings["AccumNightR"] = s.accumNightR = 0.0f;
						Settings["AccumNightG"] = s.accumNightG = 0.0f;
						Settings["AccumNightB"] = s.accumNightB = 0.0f;
						Settings["AccumDistance"] = s.accumDistance = 2000.0f;
						Settings["AccumCutOff"] = s.accumCutOff = 8500.0f;
						Settings["BlurDistance"] = s.blurDistance = 20000.0f;
						...
						Settings["SunIntensityCoeff"] = s.sunIntensityCoeff = 1.3f;
